            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden space-x-8 md:flex">
                        <button @click="scrollToSection('home')" class="text-sm hover:text-primary transition-colors">
                            Home
                        </button>
                        <button @click="scrollToSection('projects')" class="text-sm hover:text-primary transition-colors">
                            Projects
                        </button>
                        <button @click="scrollToSection('skills')" class="text-sm hover:text-primary transition-colors">
                            Skills
                        </button>
                        <button @click="scrollToSection('about')" class="text-sm hover:text-primary transition-colors">
                            About
                        </button>
                        <button @click="scrollToSection('contact')" class="text-sm hover:text-primary transition-colors">
                            Contact
                        </button>
                    </div>
                </div>
